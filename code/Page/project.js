...
function showProjectInfoTbl_macro (param)
 {
  ...
  if (""+this.wiki != "")
   str +=  "<tr>\n"
    ...
    + "  <td><a href=\"" + fixUrl(this.wiki) + "\" target=\"_blank\">"
    + fixUrl(this.wiki) + "</a></td>"
    + "</tr>";

  if (""+this.mailinglist != "")
   str +=  "<tr>\n"
    + "  <td valign=\"top\" align=\"right\">Mailing List</td>\n"
    + "  <td><a href=\"" + fixUrl(this.mailinglist) + "\" target=\"_blank\">"
    + fixUrl(this.mailinglist) + "</a></td>"
    + "</tr>";

  if (""+this.downloadlink != "")
   str +=  "<tr>\n"
    + "  <td valign=\"top\" align=\"right\">Download Link</td>\n"
    + "  <td><a href=\"" + fixUrl(this.downloadlink) + "\" target=\"_blank\">"
    + fixUrl(this.downloadlink) + "</a></td>"
    + "</tr>";
  ...
  if (""+this.repositoryurl != "")
   ...
   +
    (
     (
      this.repository=='CVS'
      || this.repository=='Bitkeeper'
      || this.repository=='Subversion'
      || this.repository=='GIT'
     )
     ? this.repository+" "
     : ""
